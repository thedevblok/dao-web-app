<template v-if="account">
  <div>
    ...
    <card
      class="mx-auto my-10 transparent"
        ...
        <div class="row">
          <div class="col-12 p-2">
            <p class="text-justify">
              The ability to create a new vote is available for anyone but requires to have understanding of QAO community and ecosystem.
              This is the governance part ruled by the community, which will rule the entire QAO ecosystem.
              This ability requires user to lock 100M for at least 1 week and will automatically lock <b>97.5m</b> QAO tokens
              As Loyalty fees being charged;  Burning <b>1.25m</b> and depositing <b>1.25m</b> in the 
              reward pool for staker tax fees  Choose wisely on what the community should take a decision.
            </p>
          </div>
        </div>
      </div>
      <form
        v-if="qaoApprovalLimit > 0"
        ...
        <div class="row">
          ...
          <div class="col-12 p-2 text-center">
            ...
            >
              <span v-if="loading">Creating.. </span> <span v-else>Create vote</span>
            </base-button>
          </div>
        </div>
      </form>
      <div class="row" v-else>
        <div class="col">
          ...
          <div class="list-holder text-center" v-if="account">
            <h2 class="sub-title">You must approve QAO to create a vote</h2>
            <approval-button />
          </div>
          <div class="list-holder text-center" v-else>
            <h2 class="sub-title">You must connect to your wallet to create a vote</h2>
            <web-3-wallet />
          </div>
        </div>
      </div>
