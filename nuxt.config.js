  ...
  head: {
    ...
    meta: [
      ...
      },
      {
          hid: 'description',
          name: 'description',
          content: '*** is the token of *** API. Voting/staking mechanisms to incentivise long term loyalty to the protocol.'
      },
      {
        hid: 'og:title',
        property: 'og:title',
      ...
      },
      {
        ...
        content: 'Write your own content. Voting/staking mechanisms to incentivise long term loyalty to the protocol.'
      },
    ],
    link: [
